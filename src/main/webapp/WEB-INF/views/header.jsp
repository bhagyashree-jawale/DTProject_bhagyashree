	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#myPage">Let'z Chat</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-left">
					<c:if test="${pageContext.request.userPrincipal.name != null}">					
						<c:if
							...
							<li><a href="<c:url value='/Message'/>">MESSAGES</a></li>
						...
						<c:if test="${pageContext.request.userPrincipal.name == 'bhagyashree'}">
							<li><a href="<c:url value='/'/>">PROFILE</a></li>
							<li><a href="<c:url value='/Category'/>">CHAT</a></li>
							<li><a href="<c:url value='/Category'/>">MESSAGES</a></li>
							<li class="dropdown"><a class="dropdown-toggle"
								data-toggle="dropdown" href="#">BLOG <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="<c:url value='/BlogAdd'/>">ADD NEW BLOG</a></li>
