		...
		<div class="rows">
			...
			<div class="col-md-7">
				...
				<div class="col-sm-8 col-md-10 col-md-offset-1">
					...
					<form:form method="POST" action="BulletineSave" class="login-form"
						commandName="bul">
						<div class="form-group input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span>
							<form:input class="form-control" type="text" path='title'
								placeholder="Bulletine Title" />
						...
						<div class="form-group input-group">
							...
							<form:textarea path="desc" class="form-control"
								placeholder="Bulletine Description" rows="20" />
						...
						<div class="form-group input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span>
							<form:input path="validDate" id="datepicker"
								class="form-control"
						...
						<div class="form-group">
							<button class="btn btn-def btn-block">ADD BULLETINE</button>
						</div>
